...
<body>
	<div id="page">
		...
		<div id="content">
			<h2>Опис</h2>
			<p>
				Цей скрипт перевіряє чи відповідає конфігурація Вашого веб-сервера
				вимогам, що висуваються до <a href="http://www.yiiframework.com/">Yii</a>
				веб-додатків. Зокрема перевіряється версія PHP, чи завантажені
				необхідні розширення PHP, а також коректність налаштувань у файлі
				php.ini.
			</p>
