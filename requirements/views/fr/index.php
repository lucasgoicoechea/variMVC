	...
	<div id="page">
		...
		<div id="content">
			...
			<p>
				...
				toutes les dépendances nécessaires pour exécuter les applications <a
					href="http://www.yiiframework.com/">Yii</a>. Il vérifie si le
				serveur exécute la version correcte de PHP, si toutes les extensions
				PHP nécessaires ont été chargées, et si les paramètres du fichier
				php.ini sont corrects
			</p>
