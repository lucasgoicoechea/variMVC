...
<body>
	<div id="page">
		...
		<div id="content">
			<h2>Описание</h2>
			<p>
				Данный скрипт проверяет соответствие конфигурации Вашего веб-сервера
				требованиям, предъявляемым веб-приложениями <a
					href="http://www.yiiframework.com/">Yii</a>. В частности,
				проверяются версия РНР и загруженные расширения РНР, а также
