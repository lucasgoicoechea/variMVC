...
<body>
	<div id="page">
		...
		<div id="content">
			<h2>תיאור</h2>
			<p>
				הסקריפט הבא בודק אם סביבת השרת שלך תוכל לעמוד בדרישות המינימום כדי
				להריץ את <a href="http://www.yiiframework.com/">Yii</a> לפיתוח
				מערכות ווב מתקדמות. הסקריפט בודק אם השרת מריץ גרסאת PHP עדכנית, אם
				הרחבות מסויימת קיימות ב PHP ונטענו בהצלחה, ואם הגדרות ה php.ini
				מוגדרות כמו שצריך.
			</p>
