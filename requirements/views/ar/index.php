...
<body>
	<div id="page">
		...
		<div id="content">
			<h2>الوصف</h2>
			<p>
				يتحقق هذا السكربت ماإذا كانت إعدادات الخادم لديك تفي بمتطلبات تشغيل
				تطبيقات الويب لاطار العمل <a href="http://www.yiiframework.com/">Yii</a>.
				يتحقق ايضا ما إذا كان الخادم يعمل على الإصدارة الصحيحة من PHP، تحميل
				اللاحقات المناسبة، وأيضا ما إذا كانت إعدادات ملف php.ini صحيحة.
			</p>
...
<tr>
	...
	<?php echo $requirement[0]; ?>
					...
					<td
						class="<?php echo $requirement[2] ? 'نجح' : ($requirement[1] ? 'فشل' : 'تنبيه'); ?>">
