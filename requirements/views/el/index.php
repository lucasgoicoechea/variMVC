...
<body>
	<div id="page">
		...
		<div id="content">
			<h2>Περιγραφή</h2>
			<p>
				Αυτή η σελίδα ελέγχει αν η παραμετροποίηση του διακομιστή σας είναι
				σωστή για την εκτέλεση των εφαρμογών ιστού του <a
					href="http://www.yiiframework.com/">Yii</a>. Ελέγχει αν ο
				διακομιστής εκτελεί τη σωστή έκδοση PHP, αν έχουν φορτωθεί οι
				κατάλληλες επεκτάσεις PHP και αν οι ρυθμίσεις του αρχείου php.ini
				είναι σωστές.
			</p>
...
<tr>
	...
	<?php echo $requirement[0]; ?>
					...
					<td
						class="<?php echo $requirement[2] ? 'πέρασε' : ($requirement[1] ? 'απέτυχε' : 'προειδοποίηση'); ?>">
