...
?>
<div class="titulo">Facturas&nbsp;A&nbsp;Cobrar</div>
...
$this->widget ( 'zii.widgets.grid.CGridView', array (
		...
		'columns' => array (
				...
				array (
					'header' => 'Cobrado',
					'value' => ' LGHelper::functions ()->formatNumber ( $data->getTotalCobrado())' 
				),
				array (
					'header' => 'PENDIENTE',
					'value' => ' LGHelper::functions ()->formatNumber ( $data->getPendienteCobro())' 
				),
				array (
						'htmlOptions' => array (
								'width' => '20px' 
