		...
		<div class="row-center">
			<label for="TipoComprobante" style="font-size: 20px">Tipo Comprobante</label>
				...
				$htmlOptionsProvincia = array (
						"ajax" => array (
								"url" => $this->createUrl ( "cambiarComprobantePagadoSinBoton" ),
								"type" => "POST",
								"update" => "#formulario",
...
?>
<?php
//medio pago va a tener q ser sobre un modelo tipo MedioPagoForm (donde luego 
//guardes el medio de pago segun el combo dle form
echo $this->renderPartial ( 'medioPago', array (
		'model' => $model,
...
<?php if($id_pago!=null) $this->actualizarTotalesGrales($model->id_pago ); ?>
</div>
</div>
