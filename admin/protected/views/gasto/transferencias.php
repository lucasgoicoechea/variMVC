...
function refreshTotalesGenerales()
{
 ...
 $.ajax({
  ...
  type: 'POST',
  //  data:data,
	  url: '<?php echo Yii::app()->createAbsoluteUrl('pago/actualizarTotalesGrales').'?refresh=true&id_pago='.$idPago; ?>',
...
<?php $transferencia = new TransferenciaPago();
 $this->widget('zii.widgets.grid.CGridView', array(
	...
	'dataProvider'=>$transferencia->searchWithPago($idPago),
...
$montoTotalTransferencias = Pago::model()->getTotalMontoTransfenrencia($idPago);?>
...
'grillaPosgrados' => 'id_transferencia_list',
	'urlOperationAction'=>Pago::model()->getUrlAgregarTransferencia($idPago)) );
?>
</div>
</div>