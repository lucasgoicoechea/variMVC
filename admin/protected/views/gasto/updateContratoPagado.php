...
<div class="titulo">Pago a Subcontrato / Medios de Pago</div>
...
// 	}
	...
	<?php
		...
		echo CHtml::link ( CHtml::image ( Yii::app ()->theme->baseUrl . "/img/icons/b_props.png" ), $model->getUrlContrato(), array (
				'style' => 'color: white',
				'class' => 'btn btn-primary',
				'target' => '_blank'  ,
                'title' => 'Ver Contrato'
