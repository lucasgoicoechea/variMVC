...
<?php $efectivo = new MedioPagoForm();
if($id_pago!=null){
...
$montoTotalEfectivo = 0.00;
if ($id_pago!=null) {
	$montoTotalEfectivo = Pago::model()->getTotalMontoMediosPago($id_pago);
}?>
<div id="id_efectivo_list">
			<div class="contenedor-fila">
				<div
					...
					<b><label>MONTO TOTAL - PAGOS </label></b> <b>$ <?php echo " ".LGHelper::functions()->formatNumber($montoTotalEfectivo); ?></b>
				</div>
			</div>
		</div>
		<br>
		<br>
<?php
$this->renderPartial ( 'createMedioPago', array (	
	'model' => $efectivo,
	'id_pago'=>$id_pago,
