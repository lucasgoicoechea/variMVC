...
$form = $this->beginWidget ( 'CActiveForm', array (
		'action' => Yii::app ()->createUrl ( 'gasto/gastosPorObra' ),
		'method' => 'get' 
) );
?>
...
function exportar(){
	 $.fn.yiiGridView.update('gasto-grid',{
       ...
       success: function() {
           ...
           window.location = '<?php echo CController::createUrl('gasto/exportarSinPaginas',array('nombreArchivo'=>'gastos-por-obra')); ?>'+$('.search-form form').serialize() + '&export=true';
       },
   });	
}					
...
<div id="resultado">
<?php if ($busqueda){
	$this->renderPartial ( '_resultadoGastosPorObra', array (
			'model' => $model
	) );
?>
