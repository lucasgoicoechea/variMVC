...
<sethtmlpageheader name="myheader" value="on" show-this-page="1" />
 ...
 mpdf-->
	<br>
	<h1 style="text-align: center">DETALLES DE SUBCONTRATO - Número: <?php echo $model->id_contrato;?></h1>
	<h3>
	...
	<table class="items" width="100%"
		...
		<thead>
			...
			<tr>
				<th class="header" width="90%">FECHA:</th>
			</tr>
			<tr>
				<td width="90%"><?php echo $model->Fecha;?></td>
			</tr>
			<tr>
				<th class="header" width="90%">PLAZO:</th>
			</tr>
			<tr>
				<td width="90%"><?php echo $model->Plazo;?></td>
			</tr>
			<tr>
				<th class="header" width="90%">PRECIO:</th>
			</tr>		
			<tr>
				<td width="90%">	<?php echo $model->Precio;?></td>
			</tr>			
			<tr>
				<th class="header" width="90%">Solicitado por:</th>
			</tr>		
			<tr>
				<td width="90%">	<?php echo $model->usuarioSolicito->username;?></td>
			</tr>
						
			<tr>
				<th class="header" width="90%">Autorizado por:</th>
			</tr>		
			<tr>
				<td width="90%">	<?php echo $model->usuarioAutorizo->username;?></td>
			</tr>
			<tr>
				<th class="header" width="90%">ACUERDO:</th>
			</tr>
			<tr>
