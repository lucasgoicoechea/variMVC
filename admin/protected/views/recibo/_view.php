...
<div class="contenedor-fila"><div class='contenedor-columna-30'>  	<b><?php echo CHtml::encode($data->getAttributeLabel('id_recibo')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id_recibo), array('view', 'id'=>$data->id_recibo)); ?>
	<br />

</div></div><div class="contenedor-fila"><div class='contenedor-columna-30'>	<b><?php echo CHtml::encode($data->getAttributeLabel('id_contrato')); ?>:</b>
