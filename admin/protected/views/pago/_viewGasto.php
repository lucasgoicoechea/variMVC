...
<div class="contenedor-fila">
	...
	<?php echo CHtml::encode($data->NumComprobante); ?>
		...
		<div class='contenedor-columna-40 center' style="border: 2px solid rgb(115, 173, 33); width: 200px; ">
			<!--style="border-radius: 25px; border: 2px solid rgb(115, 173, 33); width: 200px; text-align: left; padding: 5px;">  -->
			
			<b>MONTO --> $ <?php echo " ".CHtml::encode($data->Monto); ?></b>
		</div>
			<?php
			$imageUrl = Yii::app ()->theme->baseUrl . '/img/cruzRed.png';
			echo CHtml::link ( '<img src="' . $imageUrl . '"
				alt="Quitar Comprobante de la Orden de Pago" style="height:25px;" />', array (
