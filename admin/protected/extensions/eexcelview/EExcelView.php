...
// 				/*AGREDADO POR MI LGOICOECHEA*/
// 				$worksheet = self::$activeSheet;
// 				$worksheet->getStyle($column->getCoordinate())->getFont()->setBold(true);
// 				if($value == 'email')
// 					$worksheet->getStyle($column->getCoordinate())->getFont()->setItalic(true);
// 				/* FIN AGREEGADO*/
			}			
		}
