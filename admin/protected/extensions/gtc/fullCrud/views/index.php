...
<p>In addition to the default CRUD Generator provided by Gii, this
	Generator will:</p>

<ul>
	<li>Add the Relation Widget when generating a foreign Key so that a
		DropDownList/CheckBox/ComboBox gets displayed</li>
	<li>Add Yii::t() for every string occuring so that your Application is
		easily being able to be translated to other languages</li>
	...
	<li>Moved the submit button of Create and Update view to the
		corresponding views rather than to _form.php</li>
