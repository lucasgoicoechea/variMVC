...
<p>This generator generates an even more enhanced model class for the
	specified database table. It will include the CAdvancedArBehavior to
	add additional functions for MANY_MANY relations</p>
