	...
	<div class="container center">
		<div class="row-fluid">
			<div class="span8">
				...
				<h2>Heading</h2>
				<h4>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Esse,
				</h4>
			</div>
			<!-- /.span4 -->
			<div class="span4">
				<div class="well">
					...
					<form class="form-signin">
						...
						<button class="btn btn-primary btn-large btn-block" type="submit">Sign
							in</button>
					</form>
				...
				<li class="span3">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3>Thumbnail label</h3>
							<p>Cras justo odio, dapibus ac facilisis in, egestas eget quam.
								Donec id elit non mi porta gravida at eget .</p>
							<p>
								<a href="#" class="btn btn-primary">Action</a> <a href="#"
									class="btn">Action</a>
							</p>
